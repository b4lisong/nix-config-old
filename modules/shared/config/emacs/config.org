...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "JL Mitra"
    user-mail-address "b4lisong@pm.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/balisong/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/balisong/bin" "/profile/bin" "/Users/balisong/.npm-packages/bin" "/Users/balisong/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
