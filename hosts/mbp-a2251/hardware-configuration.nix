...

{
  ...
  # declaratively enable wifi/bluetooth
  hardware.firmware = [
  ...
  boot.initrd = {
    ...
    luks.devices."crypted-nixos" = {
      device = "/dev/disk/by-uuid/11aa6875-21b9-4c09-b0e0-5c7b32d222c5"; # /dev/nvme0n1p4
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/5F66-17ED"; # /dev/nvme0n1p1
    fsType = "vfat";
    options = [ "fmask=0022" "dmask=0022" ];
  };

  fileSystems."/nix" = {
    device = "/dev/disk/by-uuid/0cfb9f24-596c-44d9-bb74-af522c1c2836";
    fsType = "btrfs";
